            ...
            <div class="mb-3 card">
                <div class="card-header card-header-tab-animation">
                    <ul class="nav nav-justified">
                        ...
                        <li class="nav-item"><a class="active nav-link  {{request()->is('membre') ? 'active':null }}"
                                                href="{{url('membre')}}">Membre</a>
                        </li>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        {{--                projet
                                        ...
                                        projet--}}
                        <div class="tab-pane {{request()->is('membre') ? 'active':null }}" id="{{url('membre')}}"
                             role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <form method="POST" action="{{route('membre.projet')}}">
                                        @csrf
