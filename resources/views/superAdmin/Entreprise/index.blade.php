    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card  card">
                ...
                <div class="card-header">Entreprise
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="mr-2 btn-icon btn-icon-only btn btn-outline-warning">
                                        <a href="{{ route('superAdmin.Entreprise.edit', $user->id) }}">
                                ...
                                <td class="text-center">
                                    <form action="{{ route('superAdmin.Entreprise.destroy',$user->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button class="mr-2 btn-icon btn-icon-only btn btn-outline-danger remove-user">
